...
# 2. Rectangular dielectric - 100 nm x 500 nm (z). Centered transversely, closer to anode along z.
...
box = Box(xsize=0.1*(w3d.xmmax-w3d.xmmin),
...
fig = plt.figure(figsize=(12,6))
plt.title("Narrow Dielectric Particle Trace")
...
plt.xlabel('z ($\mu$m)')
plt.ylabel('x ($\mu$m)')
plt.savefig('narrow_dielectric_trace.png')
plt.close()
...
plt.savefig('Ez_narrow_box.png',bbox_inches='tight')
plt.close()
...
plt.savefig('Ex_narrow_box.png',bbox_inches='tight')
plt.close()
...
plt.savefig('phi_narrow_box.png',bbox_inches='tight')
plt.close()

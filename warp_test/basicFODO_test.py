...
# --- Set input parameters describing the beam, 72 to 20.
beam.a0       = 15.601529105582029*mm
beam.b0       =  8.759246941372836*mm
beam.emit     = 62.46985469857296e-06
beam.ap0      = 0.e0
beam.bp0      = 0.e0
beam.ibeam    = 2.e-03
beam.vbeam    = 0.e0
